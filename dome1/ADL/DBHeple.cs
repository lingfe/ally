...
namespace ADL
{
    ...
    public class DBHeple
    {
        ...
        MySqlConnection con = new MySqlConnection("server=localhost;port=3306;user id=root;CharSet=utf8;password=root;database=ally"); //根据自己的设置http://sosoft.cnblogs.com/
